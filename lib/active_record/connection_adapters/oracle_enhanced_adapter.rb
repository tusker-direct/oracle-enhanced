  ...
  module ConnectionAdapters # :nodoc:
    ...
    class OracleEnhancedAdapter < AbstractAdapter
      ...
      def next_sequence_value(sequence_name)
        # The primary key will be populated by a trigger which is maintained outside of the application
        return nil if unmanaged_autogenerated_sequences
        raise "Trigger based primary key is not supported" if sequence_name == AUTOGENERATED_SEQUENCE_NAME
